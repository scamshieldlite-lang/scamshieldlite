...
export const reportService = {
     ...
     */
    async isDuplicate({ userId, deviceFingerprint, scrubbedInput, }) {
        ...
        const existing = await db.query.reportedScams.findFirst({
            where: and(identityCondition, eq(reportedScams.scrubbedInput, scrubbedInput), gte(reportedScams.createdAt, windowStart)),
        });
        return !!existing;
    },
};
