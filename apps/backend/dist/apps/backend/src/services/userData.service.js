...
import { scans, reportedScams, auditLogs, subscriptions, consentRecords, privacySettings, devices, } from "../db/schema.js";
...
export const userDataService = {
    ...
    async exportUserData(userId) {
        const [userScans, userReports, userSubscription, userConsent, userPrivacySettings,] = await Promise.all([
     ...
     */
    async deleteScanHistory(userId) {
