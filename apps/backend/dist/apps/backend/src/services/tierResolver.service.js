    ...
    async resolveTier(userId) {
        ...
        try {
            ...
            switch (sub.status) {
                ...
                case "active": {
                    const isActive = !!sub.currentPeriodEnd && sub.currentPeriodEnd > new Date();
            ...
            logger.error({ error, userId }, "Failed to resolve tier — defaulting to expired");
            return "expired";
        }
    },
};
//# sourceMappingURL=tierResolver.service.js.map